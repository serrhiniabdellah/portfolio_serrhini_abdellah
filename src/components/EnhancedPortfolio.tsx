        ...
        <div className="flex justify-between items-center">
          ...
          <ul className={`md:flex items-center gap-4 text-zinc-400 ${isMenuOpen ? 'block absolute top-full left-0 right-0 bg-black/80 p-4 md:p-0 md:relative md:bg-transparent' : 'hidden'}`}>
            ...
            <li className="md:ml-4">
              <motion.a
                href="https://drive.google.com/file/d/121UKQK_83Z5gofxdBACR6bA1whCONU7I/view?usp=sharing"
                target="_blank"
        ...
        <>
          ...
          <main className="container mx-auto px-4 py-20">
                  ...
                  <div className="font-mono space-y-4 text-zinc-300">
                    <div className="typing-effect">
                      <div className="flex gap-4 items-center hover:bg-zinc-800/50 p-2 rounded transition-colors">
                        ...
                        <span>
                          Hi! I'm <span className="text-green-500 font-semibold">SERRHINI Abdellah</span>, 
                          a <span className="text-blue-400 font-semibold"> 💻 Software Engineering Student </span> at isty uvsq paris-saclay 📚.
                        </span>
                      </div>
                      <div className="flex gap-4 items-center hover:bg-zinc-800/50 p-2 rounded transition-colors">
                      ...
                      <div className="flex gap-4 items-center hover:bg-zinc-800/50 p-2 rounded transition-colors">
                        ...
                        <span>
                          Recognized as <span className="text-yellow-500">Employee of the Month 2 times</span>
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {['Python', 'JavaScript', 'TypeScript', 'C', 'C++', 'SQL', 'Bash', 'Java', 'Docker', 'Flutter', 'Dart', 'FlutJava/JavaFx', 'WordPress','Git'].map(skill => (
                            <motion.span
                              key={skill}
                              whileHover={{ scale: 1.05 }}
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {['Django', 'Flask', 'FastAPI', 'React', 'Tailwind', 'Pytest', 'Raylib', 'Next Js'].map(skill => (
                            <motion.span
                              key={skill}
                              whileHover={{ scale: 1.05 }}
                              className="px-3 py-1.5 bg-zinc-800/70 rounded-lg text-sm text-zinc-300 hover:bg-zinc-700/70 transition-colors cursor-default"
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {['power Bi', 'NumPy', 'Pandas', 'mongoDB', 'Spark'].map(skill => (
                            <motion.span
                              key={skill}
                              whileHover={{ scale: 1.05 }}
                              className="px-3 py-1.5 bg-zinc-800/70 rounded-lg text-sm text-zinc-300 hover:bg-zinc-700/70 transition-colors cursor-default"
              ...
              <Window title="projects.json" isActive>
                <div className="space-y-8">
                  {[
                    {
                      id: '01',
                      title: 'AI-Powered Frontend Generator',
                      year: '2025',
                      tech: ['React', 'TypeScript', 'Tailwind CSS', 'Node.js'],
                      description: 'A powerful tool to generate frontend code (HTML, CSS, React, Next.js, WordPress) from URLs or images using AI.'
                    },
                    {
                      id: '02',
                      title: 'SkyWings — Airline Reservations',
                      year: '2025',
                      tech: ['React', 'Python', 'TensorFlow', 'Next.js'],
                      description: 'A fully responsive platform for the SkyWings airline reservation platform.'
                    },
                    {
                      id: '03',
            ...
            <section id="career" className="py-20">
              <div className="flex items-center justify-between mb-8">
                ...
                >
                  <FileText className="w-4 h-4" />
                  <span className="font-mono text-sm">SERRHINI_Abdellah_resume.pdf</span>
                </motion.a>
              </div>
                  ...
                  >
                    <div className="absolute -left-[9px] top-0">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-green-500 font-mono text-sm">Aug 2024 - Present</span>
                        </div>
                      <div className="flex items-center gap-2">
                        <span className={`font-semibold ${isDarkMode ? 'text-zinc-300' : 'text-gray-700'}`}>
                        UVSQ Paris-saclay - ISTY
                        </span>
                        <span className="text-zinc-500">•</span>
                        <span className="text-zinc-500">Paris, France</span>
                      </div>
                      <div className="text-zinc-400">
                        <span className="text-purple-500 font-semibold">ISTY:</span> Engineering School
                        </div>
                      <div className="flex flex-wrap gap-2 pt-2">
                        {['Data Structures', 'Algorithms', 'Computer Networks', 'Operating Systems', 'C/C++'].map((subject) => (
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-blue-500 font-mono text-sm">Jun 2024 - Jul 2024</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className={`font-semibold ${isDarkMode ? 'text-zinc-300' : 'text-gray-700'}`}>ALTEN MAROC</span>
                        <span className="text-zinc-500">•</span>
                      ...
                      <ul className="space-y-3 text-zinc-400">
                        <li className="flex gap-2">
                          ...
                          <span>devlopped indstriel website for Stellantis</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-blue-500">→</span>
                          <span>  I have delved deep into the theoretical and practical aspects of software development </span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-blue-500">→</span>
                      ...
                      <div className="flex flex-wrap gap-2 pt-2">
                        {['PowerBi', 'React', 'Django', 'Python', 'Docker', 'SQLite, MySQL'].map((tech) => (
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-purple-500 font-mono text-sm">Aug 2020 - Jun 2024</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className={`font-semibold ${isDarkMode ? 'text-zinc-300' : 'text-gray-700'}`}>
                        Euromed University of Fes - EIDIA
                        </span>
                        <span className="text-zinc-500">•</span>
                        <span className="text-zinc-500">Fez, Morocco</span>
                      </div>
                      <div className="text-zinc-400">
                        <span className="text-purple-500 font-semibold">EIDIA:</span> Preparatory cycle
                      </div>
                      <div className="flex flex-wrap gap-2 pt-2">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Window title="me-online.sh">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      {[
                        { icon: Mail, label: 'SERRHINI-Abdellah@outlook.com', href: 'mailto:SERRHINI-Abdellah@outlook.com' },
                        { icon: Phone, label: '+33 660995200', href: 'tel:+33 660995200' },
                        { icon: MapPin, label: ' Vélizy Villacoublay, Île de France, France', href: null },
                      ].map((contact, index) => (
                        <motion.div
                          key={index}
                    ...
                    <div className="pt-4 border-t border-zinc-800">
                      <div className="space-y-4">
                        {[
                          { icon: Github, label: 'github.com/SERRHINIAbdellah', href: 'https://github.com/serrhiniabdellah' },
                          { icon: Linkedin, label: 'linkedin.com/in/SERRHINIAbdellah', href: 'https://www.linkedin.com/in/SERRHINIAbdellah' },
                          { icon: Code2, label: 'leetcode.com/iSERRHINIAbdellah', href: 'https://leetcode.com/u/serrhiniabdellah/' },
                        ].map((social, index) => (
                          <motion.div
                            key={index}
                            whileHover={{ x: 4 }}
          ...
          <footer className="bg-black/80 backdrop-blur-sm py-8">
            <div className="container mx-auto px-6 text-center">
              <p className="text-zinc-400">Copyright &copy; 2025 SERRHINI Abdellah. All rights reserved.</p>
            </div>
          </footer>
          <Analytics />
        </>
